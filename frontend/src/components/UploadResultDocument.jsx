...
const UploadResultDocument = ({
  ...
  return (
    <div className="min-w-7xl mt-5 justify-center bg-gray-50 rounded-2xl p-6 mx-auto fadeInUp animated faster">
      <div className="flex flex-row justify-between place-content-center mb-4 bg-blue-100/50 rounded-t-lg p-2">
        <div className="pl-3 text-2xl font-semibold text-blue-600 place-content-center">
          문서 비식별화 결과
        </div>
