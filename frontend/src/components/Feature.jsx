          ...
          <div class="flex flex-wrap -mx-4">
            <div class="w-full px-4 md:w-1/2 lg:w-1/4">
              <div class="mb-12 group">
                <div class="relative mb-10 flex h-[70px] w-[70px] items-center justify-center rounded-[14px]">
                  <span class="absolute bg-[#2c7eff] z-1 rotate-[25deg] group-hover:rotate-45 opacity-30 duration-300 rounded-[14px] w-[70px] h-[70px] left-0 top-0 items-center justify-center"></span>
                  <span class="absolute bg-[#2c7eff] z-1 duration-300 rounded-[14px] w-[70px] h-[70px] left-0 top-0 items-center justify-center"></span>
                  <svg
                    className="z-2"
                    width="37"
                    height="37"
